...
import Sidebar from "../chef/sidebar";
...
export default function ChefLayout() {
  ...
  const breadcrumbMap = {
    "/chef/Dashboard": { title: "Tableau de bord", parent: "Espace Chef" },
    "/chef/ChefProfile": { title: "Profil", parent: "Espace Chef" },
  ...
  const routesWithOwnHeader = ["/chef/projeteDetail"];
