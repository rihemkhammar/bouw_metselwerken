...
import { getProjectsChef, fetchChefProfile } from "../../services/api";

const ChefDashboardDetailed = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const profileData = await fetchChefProfile(userId, token);
        setProfile(profileData);

        const projectsData = await getProjectsChef(userId);
...
export default ChefDashboardDetailed;